...
def get_args():
    ...
    parser.add_argument('-mic-name', type=str, default="Cotron EZM-001")  # JLAB TALK GO MICROPHONE, Cotron EZM-001
    parser.add_argument('-save-audio', type=str, default='./audio')
    ...
    parser.add_argument('-trans-freq', type=str, default=22000, help='Transmitter frequency(Hz)')
...
class WebcamClient:
    ...
    def displays(self):
        ...
        if args.audio:
            ...
            for idx in range(self.audio.get_device_count()):
                if args.mic_name in self.audio.get_device_info_by_index(idx).get('name'):
    ...
    def record_video(self):
        ...
        save_path = os.path.join(root_folder, 'video_{}.mp4'.format(int(time.time())))
    ...
    def record_audio(self):
        ...
        save_path = os.path.join(root_folder, 'audio_{}.wav'.format(self.time))
    ...
    def save_experiment_data(self):
        ...
        experiment_data = {
            ...
            'tramsmitter': args.trans_freq,
            'grid': args.grid,
            'x,y,z': [args.x, args.y, args.z],
            'spectrogram': spec.tolist(),  # Convert numpy array to list for JSON serialization
        }

        root_folder = args.save_audio
        json_path = os.path.join(root_folder, 'data_{}.json'.format(self.time))
