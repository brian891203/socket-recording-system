...
def get_args():
    ...
    parser.add_argument('-host', type=str, default='localhost', help='Server host')  #'192.168.0.100'
    ...
    parser.add_argument('-save-audio', type=str, default='./audio50')
...
class WebcamClient:
    ...
    def record_audio(self):
        ...
        save_path = os.path.join(root_folder, 'audio_{}_c2a1.wav'.format(self.time))
    ...
    def save_experiment_data(self):
        ...
        root_folder = args.save_audio
        json_path = os.path.join(root_folder, 'data_{}_c2a1.json'.format(self.time))
